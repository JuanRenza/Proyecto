 ...
 * @author W°
 */
public class EliminarTienda extends javax.swing.JFrame {

    
    LinkedList<Tienda> listaTienda;
    /**
     * Creates new form EliminarTienda
     */
    public EliminarTienda() {
        initComponents();
        listaTienda=new LinkedList<>();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarTienda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarTienda().setVisible(true);
            }
        });
    }
